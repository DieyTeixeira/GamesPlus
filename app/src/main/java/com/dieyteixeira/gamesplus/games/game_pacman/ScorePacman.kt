...
fun ScorePacman(
    ...
    var showClearRecordPacman by remember { mutableStateOf(false) }

    if (showClearRecordPacman) {
        ShowClearRecordPacman(
            onNo = { showClearRecordPacman = false },
            onYes = {
                showClearRecordPacman = false

                clearPlayerRecordPacman(context, "Pacman")
    ...
    Row(
        ...
        Row(
            modifier = Modifier
                ...
                .clickable { showClearRecordPacman = true },
            horizontalArrangement = Arrangement.Center,
            verticalAlignment = Alignment.CenterVertically
        ) {
            ...
            Column(
                ...
                Box(
                    ...
                    Text(
                        text = "${playerRecordPacman.second}",
