...
import com.dieyteixeira.gamesplus.games.game_memory.GameModeSelector
import com.dieyteixeira.gamesplus.games.game_memory.GridSize
import com.dieyteixeira.gamesplus.games.game_memory.GridSizeSelector
import com.dieyteixeira.gamesplus.games.game_memory.NameAndColorSelector
    ...
    Column(
        ...
        Box(
            modifier = Modifier
                ...
                .clickable {
                    if (isValid) {
                        onStartGame(State(playerName, playerColor))
                    } else {
                        showError = true
                    }
                },
